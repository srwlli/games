...
export default function MemoryMatch() {
  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-purple-950 via-zinc-950 to-purple-950 flex flex-col items-center justify-between p-4 sm:p-8 relative overflow-hidden">
      {/* Unified HUD */}
      <UnifiedHUD
        stats={[
      ...
      <div className="flex-grow flex items-center justify-center w-full min-h-0 py-4">
        <div className="grid grid-cols-4 gap-3 sm:gap-4 max-w-lg w-full px-4 max-h-full overflow-hidden" style={{ perspective: "1000px" }}>
          {cards.map((card) => {
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <Icon size={40} className="text-white sm:w-12 sm:h-12 drop-shadow-lg" strokeWidth={2.5} />
                    </div>
