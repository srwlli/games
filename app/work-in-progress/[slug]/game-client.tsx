...
export default function WipGameClient({ gameData }: { gameData: GameData }) {
  ...
  return (
    <div className="fixed inset-0 bg-zinc-950 flex flex-col h-screen overflow-hidden">
      ...
      >
        <Link href="/work-in-progress" className="flex items-center gap-2 text-zinc-400 hover:text-white transition-colors">
          <ArrowLeft size={20} />
          <span className="text-sm font-bold uppercase tracking-tighter">Back to Work In Progress</span>
        </Link>
