...
export default function MathGameClient({ gameData }: { gameData: GameData }) {
  ...
  return (
    <div className="fixed inset-0 bg-zinc-950 flex flex-col h-screen overflow-hidden">
      ...
      >
        <Link href="/math-games" className="flex items-center gap-2 text-zinc-400 hover:text-white transition-colors">
          <ArrowLeft size={20} />
          <span className="text-sm font-bold uppercase tracking-tighter">Back to Math Games</span>
        </Link>
